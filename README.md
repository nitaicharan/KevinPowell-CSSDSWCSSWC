...
<p align="center">:bangbang: Documentation available to access at: https://nitaicharan.github.io/KevinPowell-CSSDSWCSSWC :bangbang:</p>

<!--[![](PREVIEW.png)](https://nitaicharan.github.io/Udemy-CCDNJSMDB1/)-->
<a href="https://nitaicharan.github.io/KevinPowell-CSSDSWCSSWC">
  <p align="center">
    <img src="PREVIEW.png">
  </p>
</a>
...
This project was part of the Kevin Powell | CSS Evangelist course "CSS Demystified: Start Writing CSS with Confidence" by Kevin Powell.
...
This certificate above verifies that [Nitai Charan][udemy-url] successfully completed the course [CSS Demystified: Start Writing CSS with Confidence][course-url] on ??/??/??? as taught by [Kevin Powell][instructor-url] on Kevin Powell | CSS Evangelist. The certificate indicates the entire course was completed as validated by the student.
...
[course-url]: https://cssdemystified.com/
[instructor-url]: https://www.kevinpowell.co/about/
[certificate-url]: #
